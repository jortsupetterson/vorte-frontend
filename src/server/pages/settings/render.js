...
const stylesheets = `
    <link id="settings-styles" rel="stylesheet" href="/V£RSION/styles/apps/my-vorte/settings/style.css">
    `;

const events = `<script type="module" src="/V£RSION/scripts/events/settings/handleEvents.js" defer></script>`;
