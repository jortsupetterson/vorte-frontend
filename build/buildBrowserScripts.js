...
export default async function buildBrowserScripts(entry = ['./src/client/main/app.js'], outDir = './dist/assets/scripts', version) {
	...
	await emptyDir('./dist/assets/scripts');
	...
	return build({
		...
		target: ['es2024'],
		minify: true,
		plugins: [htmlMinifierPlugin(version)],
		external: ['/scripts/*'],
		splitting: false,
		outdir: outDir,
		logLevel: 'info',
